      ...
      <div className='container mx-auto mb-24'>
        ...
        >
          ...
          <div className='flex-1 flex flex-col xl:items-center'>
            <div>
              <h3 className='h3 font-bold mb-8'>Compañia</h3>
          ...
          <div className='flex-1'>
            <h3 className='h3 font-bold mb-8'>Horas</h3>
            <div className='flex flex-col gap-y-4'>
              <div className='flex gap-x-2'>
                <div className='text-secondary'>Lunes-Viernes:</div>
                <div className='font-semibold'>09:00AM - 09:00PM</div>
              </div>
              <div className='flex gap-x-2'>
                <div className='text-secondary'>Sábados:</div>
                <div className='font-semibold'>09:00AM - 07:00PM</div>
              </div>
              <div className='flex gap-x-2'>
                <div className='text-secondary'>Domingos:</div>
          ...
          {/* newsletter */}
          <div className='flex-1'>
            <h3 className='h3 font-bold mb-8'>Boletin informativo</h3>
