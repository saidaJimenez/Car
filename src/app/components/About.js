        ...
        <div className='flex flex-col xl:flex-row xl:justify-between'>
          ...
          <div className='flex-1 flex items-center xl:justify-center'>
            <div className='xl:max-w-[517px]'>
              ...
              >
                Alquile, elija y repare con facilidad. Nuestras convenientes ubicaciones,
                 diversos tipos de automóviles y puntos de reparación confiables garantizan una perfecta
                 experiencia en coche.
              </motion.p>
              {/* stats */}
              <motion.div
